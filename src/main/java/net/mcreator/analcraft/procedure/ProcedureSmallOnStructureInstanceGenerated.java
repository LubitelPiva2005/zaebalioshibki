...
public class ProcedureSmallOnStructureInstanceGenerated extends ElementsAnalcraftMod.ModElement {
	public ProcedureSmallOnStructureInstanceGenerated(ElementsAnalcraftMod instance) {
		super(instance, 22);
	}
