...
public class ProcedureLockerroomOnStructureInstanceGenerated extends ElementsAnalcraftMod.ModElement {
	public ProcedureLockerroomOnStructureInstanceGenerated(ElementsAnalcraftMod instance) {
		super(instance, 37);
	}
		...
		if (((((!((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == Blocks.AIR.getDefaultState().getBlock()))
			...
			if (!world.isRemote) {
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("analcraft", "roommmmmmmusic"));
				if (template != null) {
