...
public class ProcedureLejaOnStructureInstanceGenerated extends ElementsAnalcraftMod.ModElement {
	public ProcedureLejaOnStructureInstanceGenerated(ElementsAnalcraftMod instance) {
		super(instance, 30);
	}
