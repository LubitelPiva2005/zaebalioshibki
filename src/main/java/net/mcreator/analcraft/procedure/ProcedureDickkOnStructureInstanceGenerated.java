...
public class ProcedureDickkOnStructureInstanceGenerated extends ElementsAnalcraftMod.ModElement {
	public ProcedureDickkOnStructureInstanceGenerated(ElementsAnalcraftMod instance) {
		super(instance, 20);
	}
