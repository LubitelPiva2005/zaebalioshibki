...
public class BlockAncientseemen extends ElementsAnalcraftMod.ModElement {
	@GameRegistry.ObjectHolder("analcraft:ancientseemen")
	public static final Block block = null;
	public BlockAncientseemen(ElementsAnalcraftMod instance) {
		super(instance, 73);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ancientseemen"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("analcraft:ancientseemen", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("ancientseemen");
