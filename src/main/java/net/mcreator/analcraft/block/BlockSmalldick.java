...
public class BlockSmalldick extends ElementsAnalcraftMod.ModElement {
	@GameRegistry.ObjectHolder("analcraft:smalldick")
	public static final Block block = null;
	public BlockSmalldick(ElementsAnalcraftMod instance) {
		super(instance, 66);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("analcraft:smalldick", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("smalldick");
			setRegistryName("smalldick");
		}
