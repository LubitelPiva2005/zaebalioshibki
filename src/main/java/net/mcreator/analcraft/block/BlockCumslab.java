...
public class BlockCumslab extends ElementsAnalcraftMod.ModElement {
	@GameRegistry.ObjectHolder("analcraft:cumslab")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("analcraft:cumslab_double")
	public static final Block block_slab_double = null;
	public BlockCumslab(ElementsAnalcraftMod instance) {
		super(instance, 95);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("cumslab"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("cumslab_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("analcraft:cumslab", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("cumslab");
