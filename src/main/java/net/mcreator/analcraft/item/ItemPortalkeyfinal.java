...
import net.mcreator.analcraft.procedure.ProcedurePortalkeyfinalRightClickedOnBlock;
...
public class ItemPortalkeyfinal extends ElementsAnalcraftMod.ModElement {
	@GameRegistry.ObjectHolder("analcraft:portalkeyfinal")
	public static final Item block = null;
	public ItemPortalkeyfinal(ElementsAnalcraftMod instance) {
		super(instance, 108);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public EnumActionResult onItemUse(EntityPlayer entity, World world, BlockPos pos, EnumHand hand, EnumFacing direction, float hitX,
				...
				ItemStack itemstack = entity.getHeldItem(hand);
				{
					...
					ProcedurePortalkeyfinalRightClickedOnBlock.executeProcedure($_dependencies);
				}
				return retval;
			}
		}.setUnlocalizedName("portalkeyfinal").setRegistryName("portalkeyfinal").setCreativeTab(TabAnaltab.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("analcraft:portalkeyfinal", "inventory"));
	}
