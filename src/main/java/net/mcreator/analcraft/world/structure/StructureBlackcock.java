...
import net.mcreator.analcraft.procedure.ProcedureBlackcockOnStructureInstanceGenerated;
...
public class StructureBlackcock extends ElementsAnalcraftMod.ModElement {
	public StructureBlackcock(ElementsAnalcraftMod instance) {
		super(instance, 65);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 5000) {
			...
			for (int a = 0; a < count; a++) {
				...
				int z = spawnTo.getZ();
				{
					...
					ProcedureBlackcockOnStructureInstanceGenerated.executeProcedure($_dependencies);
				}
			}
		}
	}
