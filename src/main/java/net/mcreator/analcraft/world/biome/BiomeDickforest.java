...
import net.mcreator.analcraft.block.BlockCumlog;
import net.mcreator.analcraft.block.BlockCumleaves;
import net.mcreator.analcraft.ElementsAnalcraftMod;

import java.util.Random;

@ElementsAnalcraftMod.ModElement.Tag
public class BiomeDickforest extends ElementsAnalcraftMod.ModElement {
	@GameRegistry.ObjectHolder("analcraft:dickforest")
	public static final BiomeGenCustom biome = null;
	public BiomeDickforest(ElementsAnalcraftMod instance) {
		super(instance, 17);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			super(new Biome.BiomeProperties("Dickforest").setRainfall(0.5F).setBaseHeight(0.1F).setWaterColor(-1).setHeightVariation(0.07F)
			...
			this.spawnableCreatureList.add(new SpawnListEntry(EntityVan.EntityCustom.class, 15, 1, 15));
			this.spawnableCreatureList.add(new SpawnListEntry(EntitySemenlime.EntityCustom.class, 15, 1, 15));
		}
	...
	static class CustomTree extends WorldGenAbstractTree {
		...
		public boolean generate(World world, Random rand, BlockPos position) {
			...
			if (position.getY() >= 1 && position.getY() + height + 1 <= world.getHeight()) {
				...
				if (!spawnTree) {
					...
					if (!((ground == BlockSpermegrass.block.getDefaultState().getBlock() || ground == Blocks.STONE.getStateFromMeta(0).getBlock())
							&& (ground2 == BlockSpermegrass.block.getDefaultState().getBlock()
					...
					if (position.getY() < world.getHeight() - height - 1) {
								...
								for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; ++i2) {
									...
									if (Math.abs(position.getX()) != j1 || Math.abs(j2) != j1 || rand.nextInt(2) != 0 && i4 != 0) {
										...
										if (state.getBlock().isAir(state, world, blockpos) || state.getBlock().isLeaves(state, world, blockpos)
												...
												|| state.getBlock() == BlockCumleaves.block.getDefaultState().getBlock()) {
											this.setBlockAndNotifyAdequately(world, blockpos, BlockCumleaves.block.getDefaultState());
										}
									}
								}
							}
						...
						for (int genh = 0; genh < height; genh++) {
							...
							if (state.getBlock().isAir(state, world, genhPos) || state.getBlock() == Blocks.VINE.getDefaultState().getBlock()
									|| state.getBlock() == BlockCumleaves.block.getDefaultState().getBlock()) {
								this.setBlockAndNotifyAdequately(world, position.up(genh), BlockCumlog.block.getDefaultState());
							}
						}
		...
		protected boolean canGrowInto(Block blockType) {
			return blockType.getDefaultState().getMaterial() == Material.AIR || blockType == BlockCumlog.block.getDefaultState().getBlock()
					|| blockType == BlockCumleaves.block.getDefaultState().getBlock()
					|| blockType == BlockSpermegrass.block.getDefaultState().getBlock() || blockType == Blocks.STONE.getStateFromMeta(0).getBlock();
		}
