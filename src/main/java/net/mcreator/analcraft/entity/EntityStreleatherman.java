...
public class EntityStreleatherman extends ElementsAnalcraftMod.ModElement {
	public static final int ENTITYID = 13;
	public static final int ENTITYID_RANGED = 14;
	public EntityStreleatherman(ElementsAnalcraftMod instance) {
		super(instance, 82);
	}
	...
	public void initElements() {
		elements.entities
				.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("analcraft", "streleatherman"), ENTITYID)
						.name("streleatherman").tracker(64, 3, true).egg(-16777216, -39322).build());
	}
