...
import net.mcreator.analcraft.procedure.ProcedureTrader;
...
public class GuiTorgovecc extends ElementsAnalcraftMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiTorgovecc(ElementsAnalcraftMod instance) {
		super(instance, 43);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 25, 30) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 133, 30) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("analcraft:textures/torgovecc.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Fisting is 300$", 51, 11, -16777216);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 60, this.guiTop + 47, 60, 20, "Fisting"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			AnalcraftMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureTrader.executeProcedure($_dependencies);
			}
		}
	}
